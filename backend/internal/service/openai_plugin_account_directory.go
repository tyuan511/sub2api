...
//   - Groups / AccountGroups / Proxies: relational graphs and proxy bindings
//     include back-references and proxy credentials. encoding/json does NOT
//     detect reference cycles and would recurse into a stack-overflow panic if
//     reverse relations are populated. GroupIDs already conveys membership and
//     the resolved proxy is handled by the outbound-identity channel, so drop
//     these for correctness and secrecy.
//
