...
type SystemSettings struct {
	...
	// ChannelMonitorBazaarLinkProbeEnabled gates manual + scheduled identity probes.
	ChannelMonitorBazaarLinkProbeEnabled bool `json:"channel_monitor_bazaarlink_probe_enabled"`
	// ChannelMonitorBazaarLinkProbeCron is a 5-field cron for the scheduled batch.
