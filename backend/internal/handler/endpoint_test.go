...
func TestNormalizeInboundEndpoint(t *testing.T) {
	tests := []struct {
		...
		{"/v1/images/studio/generations", EndpointImagesGenerations},
		{"/v1/images/studio/edits", EndpointImagesEdits},
		{"/v1/images/generations/async", EndpointImagesGenerations},
		{"/v1/images/edits/async", EndpointImagesEdits},
