...
const (
	...
	// ContextKeyAPIKeyRouteState freezes the candidate-group plan selected at
	// authentication time for the lifetime of the request.
	ContextKeyAPIKeyRouteState ContextKey = "api_key_route_state"
