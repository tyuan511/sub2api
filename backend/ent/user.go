...
type UserEdges struct {
	// RoutingArtifactVersions holds the value of the routing_artifact_versions edge.
	RoutingArtifactVersions []*RoutingArtifactVersion `json:"routing_artifact_versions,omitempty"`
	// RoutingExperiments holds the value of the routing_experiments edge.
	RoutingExperiments []*RoutingExperiment `json:"routing_experiments,omitempty"`
...
// RoutingArtifactVersionsOrErr returns the RoutingArtifactVersions value or an error if the edge
// was not loaded in eager-loading.
func (e UserEdges) RoutingArtifactVersionsOrErr() ([]*RoutingArtifactVersion, error) {
	if e.loadedTypes[0] {
		return e.RoutingArtifactVersions, nil
	}
	return nil, &NotLoadedError{edge: "routing_artifact_versions"}
}

// RoutingExperimentsOrErr returns the RoutingExperiments value or an error if the edge
// was not loaded in eager-loading.
func (e UserEdges) RoutingExperimentsOrErr() ([]*RoutingExperiment, error) {
	if e.loadedTypes[1] {
		return e.RoutingExperiments, nil
	}
	return nil, &NotLoadedError{edge: "routing_experiments"}
}
...
// QueryRoutingArtifactVersions queries the "routing_artifact_versions" edge of the User entity.
func (_m *User) QueryRoutingArtifactVersions() *RoutingArtifactVersionQuery {
	return NewUserClient(_m.config).QueryRoutingArtifactVersions(_m)
}

// QueryRoutingExperiments queries the "routing_experiments" edge of the User entity.
func (_m *User) QueryRoutingExperiments() *RoutingExperimentQuery {
	return NewUserClient(_m.config).QueryRoutingExperiments(_m)
}
