...
var (
	...
	AccountProxiesTable = &schema.Table{
		...
		PrimaryKey: []*schema.Column{AccountProxiesColumns[4], AccountProxiesColumns[5]},
		ForeignKeys: []*schema.ForeignKey{
			{
		...
		Indexes: []*schema.Index{
			...
			{
				Name:    "accountproxy_account_id_sort_order",
				Unique:  false,
				Columns: []*schema.Column{AccountProxiesColumns[4], AccountProxiesColumns[1]},
			},
		},
	}
	...
	ChannelMonitorHistoriesColumns = []*schema.Column{
		...
		{Name: "tokens_per_second", Type: field.TypeFloat64, Nullable: true},
	...
	UsageLogsColumns = []*schema.Column{
		...
		{Name: "is_monitor", Type: field.TypeBool, Default: false},
		{Name: "channel_monitor_id", Type: field.TypeInt64, Nullable: true},
