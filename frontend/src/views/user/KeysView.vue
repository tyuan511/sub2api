...
watch([showCreateModal, createProviderOptions], ([isOpen, providers], [wasOpen]) => {
  ...
  if (!formGroupOptions.value.some((group) => group.value === formData.value.group_routes[0])) {
    formData.value.group_routes = []
  }
})
