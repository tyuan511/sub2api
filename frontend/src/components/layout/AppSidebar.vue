...
function buildSelfNavItems(withDashboard: boolean): NavItem[] {
  ...
  items.push(
    ...
    { path: '/image-studio', label: t('imageStudio.title'), icon: BatchImageIcon },
...
const adminNavItems = computed((): NavItem[] => {
  const baseItems: NavItem[] = [
    ...
    { path: '/admin/routing-optimization', label: t('nav.routingOptimization'), icon: ChartIcon, hideInSimpleMode: true },
