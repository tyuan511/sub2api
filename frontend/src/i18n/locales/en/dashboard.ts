export default {
  ...
  keys: {
    ...
    routeGroupsLabel: 'Candidate groups',
    routeGroupsHelpTitle: 'One key can bind multiple groups',
    routeGroupsHelpFailover: 'If the current group cannot serve the request, traffic fails over to the next group that still can.',
    routeGroupsHelpModels: 'Requests go to a group that supports the model, so one key can use every selected group\'s models.',
    routeGroupsHelpBilling: 'Each request is still routed to one group and billed at that group\'s rate.',
    routeGroupsHelpSequential: 'Sequential: try groups from top to bottom.',
    routeGroupsHelpSmart: 'Smart: rank groups by price and stability.',
    selectRouteGroups: 'Add candidate groups',
    routeGroupsSelected: '{count}/{max} groups selected',
    routeGroupHint: 'Choose up to {max} groups with the same billing type; platforms may differ. Requests go to a group that actually supports the model. Each request is still routed to one concrete group and billed at that group\'s rate. Drag the list to set failover order.',
    routePrimaryGroup: 'Primary group',
    routeFallbackGroup: 'Fallback group',
    routeGroupRate: 'Current rate ×{rate}',
    routeGroupUnavailable: 'Unavailable',
    routeGroupUnavailableReason: 'This group is not available for new bindings',
    routeGroupLimitReached: 'You can select at most {max} candidate groups',
    routeGroupPlatformMismatch: 'Choose groups on the same platform as the first group',
    routeGroupBillingMismatch: 'Choose groups with the same billing type as the first group',
    dragToReorder: 'Drag to reorder',
    removeGroup: 'Remove group',
    scheduleModeLabel: 'Failover mode',
    scheduleSequential: 'Sequential failover',
    scheduleSequentialDescription: 'Try groups from top to bottom, switching only after resources in a group are exhausted.',
    scheduleSmart: 'Smart failover',
    scheduleSmartDescription: 'Dynamically rank your selected groups by price and stability.',
    smartPreferenceLabel: 'Smart failover preference',
    balanceRatio: 'Price {price}% · Stability {stability}%',
    sliderPrice: 'Lower cost',
    sliderSpeed: 'Faster response',
    sliderStability: 'More stable',
    resetBalance: 'Reset to balanced',
    presetLowest: 'Rock-bottom price',
    presetLowestHint: 'Cheapest first',
    presetLowestDesc: 'Almost all weight on price. Use when stability is not a concern.',
    presetThrifty: 'Thrifty',
    presetThriftyHint: 'Save, with a safety net',
    presetThriftyDesc: 'Mostly price, with a little success-rate cushion.',
    presetBalanced: 'Balanced',
    presetBalancedHint: 'Split price and stability',
    presetBalancedDesc: 'An even mix of price and success rate for everyday use.',
    presetRock: 'Steady as a rock',
    presetRockHint: 'Stay up first',
    presetRockDesc: 'Success rate dominates. Price barely matters.',
    weightReliability: 'Reliability',
    weightCapacity: 'Capacity',
    weightPrice: 'Price',
    weightSpeed: 'Duration',
    weightTTFT: 'First token',
    successThreshold: 'Success-rate circuit breaker',
    successThresholdDescription: 'Pause groups below this success rate',
    thresholdFlexible: '50% · Flexible',
    thresholdStrict: '95% · Strict',
    resetThreshold: 'Reset to 80%',
    successThresholdHint: '5% steps, applied after enough samples, only for this key. Higher thresholds may reduce availability. If no group qualifies, the threshold is not lowered. Recovery requires cooldown and probing.',
    preferencePrice: 'Price first',
    preferencePriceDescription: 'Reduce the effective cost per successful request (rate multiplier and cache hits).',
    preferenceSpeed: 'Stability first',
    preferenceSpeedDescription: 'Prefer higher success with faster first-token latency.',
    preferenceBalanced: 'Balanced',
    preferenceBalancedDescription: 'Split weight evenly between price and stability.',
    smartSchedulingDisclosure: 'Ranking stays within the groups you selected. Healthy sessions keep their group; usage and billing follow the group that actually served the request.',
    smartStrategyVersion: 'Current strategy {version} · updated {time}',
    smartStrategyPending: 'No valid score snapshot is available yet; requests will follow your configured group order.',
		routeCurrentRank: 'Current rank #{rank}',
		routeEffectiveRate: 'Cache-adjusted ×{rate}',
		routeSuccessRate: 'Success {rate}',
		routeTTFT: 'First token {value}ms',
		routeDuration: 'Duration {value}ms',
		routeCacheHit: 'Cache hit {rate}',
		routePredictedShare: 'Expected share {rate}',
		routeConfidence: {
			low: 'Low confidence',
			medium: 'Medium confidence',
			high: 'High confidence'
		},
		estimatedRateTitle: 'Current estimated rate',
		estimatedRateWindow: 'Window {window}',
		estimatedRateSamples: 'Sample: {input} input / {output} output tokens',
		estimatedRateObservedShare: 'Landing share: {samples} observed in {window} (~{effective} effective)',
		estimatedRateModeledShare: 'Landing share: retry-order model (insufficient observations)',
		estimatedRateDisclaimer: 'This interval is an estimate based on the current eligible candidates, cache mix, and failover probability. It is not a fixed quote; settlement uses the group that actually serves the request and its actual usage.',
    clickToEditRouting: 'Edit candidate groups and failover policy',
    routeConfigConflict: 'This key routing configuration changed in another session. The latest version has been reloaded; please edit it again.',
    usage: 'Usage',
    today: 'Today',
    total: 'Last 30d',
    quota: 'Quota',
  ...
  usage: {
    ...
    totalTokens: 'Total Tokens',
    cacheTotal: 'Cache',
    cacheHitRateHint: 'Cache read tokens ÷ (input tokens + cache read tokens + cache creation tokens)',
