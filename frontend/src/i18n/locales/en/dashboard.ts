export default {
  ...
  keys: {
    ...
    routeGroupsLabel: 'Candidate groups and order',
    selectRouteGroups: 'Add candidate groups',
    routeGroupsSelected: '{count}/{max} groups selected',
    routeGroupHint: 'Choose up to {max} groups with the same platform and billing type. The list order is the failover order.',
    ...
    preferenceSpeedDescription: 'Prefer higher success with faster first-token and overall latency.',
    preferenceBalanced: 'Balanced',
    preferenceBalancedDescription: 'Split weight evenly between price and stability.',
    smartSchedulingDisclosure: 'The slider splits weight in 5% steps between price (rate multiplier + cache hits) and stability (success + first token + duration). Success rate is a score, not a hard cutoff. Optimization stays within the groups you selected; healthy existing sessions remain on their group, new sessions use the latest ranking, and usage and billing follow the group that actually served the request.',
    ...
    clickToEditRouting: 'Edit candidate groups and scheduling policy',
