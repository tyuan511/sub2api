export default {
  ...
  keys: {
    ...
    scheduleSmartDescription: 'Dynamically rank your selected groups by health, price, speed, and capacity.',
    smartPreferenceLabel: 'Smart scheduling preference',
    balanceRatio: 'Price {price}% · Speed {speed}%',
    ...
    preferencePriceDescription: 'After the success guardrail is met, reduce the effective cost per successful request.',
    preferenceSpeed: 'Speed first',
    preferenceSpeedDescription: 'After the success guardrail is met, reduce time to final success.',
    preferenceBalanced: 'Balanced',
    preferenceBalancedDescription: 'Balance success, cost, speed, capacity, and routing stability.',
    smartSchedulingDisclosure: 'Every preference is gated by the success-rate threshold. Optimization stays within the groups you selected; healthy existing sessions remain on their group, new sessions use the latest ranking, and usage and billing follow the group that actually served the request.',
