export default {
    settings: {
      ...
      telegram: {
        title: 'Telegram Bot',
        description: 'Configure the shared Telegram bot for support notifications and /stats. After binding, send /stats in a private chat to view relay concurrency, monitoring, and today\'s usage.',
        enabled: 'Enable bot',
        enabledHint: 'When off, the webhook, support notifications, and /stats are stopped.',
        botToken: 'Bot Token',
        botTokenPlaceholder: '123456:ABC...',
        botTokenConfiguredPlaceholder: 'Configured. Leave blank to keep the current token.',
        webhookBaseURL: 'Public webhook URL',
        webhookBaseURLPlaceholder: 'https://api.example.com',
        webhookHint: 'Must be an HTTPS URL that can reach this Sub2API instance. The webhook is registered automatically.',
        statsCronEnabled: 'Schedule /stats',
        statsCronEnabledHint: 'Push the same /stats report to every bound admin chat on a cron. Sends only while the bot is enabled.',
        statsCron: 'Schedule cron',
        statsCronHint: 'Standard 5-field cron (min hour day month weekday), interpreted in the app timezone. Examples: 0 * * * * hourly; 0 9 * * * daily at 09:00; */30 * * * * every 30 minutes.',
        save: 'Save configuration',
        saveSuccess: 'Telegram configuration saved',
        saveFailed: 'Failed to save',
        loadFailed: 'Failed to load Telegram configuration',
        webhookRegistered: 'Webhook registered',
        webhookUnregistered: 'Webhook not registered',
        bindingTitle: 'My notification binding',
        bindingDescription: 'Each admin binds their own Telegram private chat. After binding, send /stats to query station status.',
        generateLink: 'Generate bind link',
        generateLinkFailed: 'Failed to generate bind link',
        generateLinkHint: 'The bind link is valid for 10 minutes. Reopen this page after completing it in Telegram.',
        testNotify: 'Send test',
      ...
      payment: {
        ...
        field_currencies: 'Allowed currencies',
        field_timeoutSeconds: 'Order timeout (seconds)',
        ...
        field_bepusdtApiBaseHint: 'BEpusdt service URL, for example https://bepusdt.fastvibe.dev.',
        field_bepusdtCurrenciesHint: 'Separate multiple currencies with commas, for example USDT. It is recommended to allow only USDT initially.',
        field_bepusdtTimeoutHint: 'BEpusdt requires at least 180 seconds; the default is 1800 seconds.',
