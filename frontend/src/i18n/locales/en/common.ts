export default {
  common: {
    ...
    support: {
      title: 'FastVibe Support',
      close: 'Close support window',
      loading: 'Loading...',
      emptyTitle: 'How can we help?',
      emptyDescription: 'Send a message and an administrator will reply here.',
      agentAlt: 'FastVibe Support',
      previewAttachment: 'Preview {name}',
      attachmentLoading: 'Loading...',
      sendImage: 'Send image',
      addImage: 'Add image',
      pendingImages: '{count} image(s) ready to send',
      clearImages: 'Clear images',
      removeImage: 'Remove image',
      inputPlaceholder: 'Type a message, press Enter to send',
      send: 'Send',
      sending: 'Sending...',
      loadFailed: 'Failed to load support messages',
      tooManyImages: 'Select up to 2 images, with a maximum of 3 MB per image',
    ...
    supportAdmin: {
      openWorkspace: 'Open support workspace',
      closeWorkspace: 'Close support workspace',
      workspaceTitle: 'Support Workspace',
      workspaceSubtitle: 'User messages and Telegram replies',
      workspaceLabel: 'Support workspace',
      telegramNotifications: 'Telegram notifications',
      refreshConversations: 'Refresh all conversations',
      restoreWindow: 'Restore support window',
      fullscreenWindow: 'Show support window fullscreen',
      restore: 'Restore',
      enlarge: 'Enlarge',
      ...
      nextPage: 'Next',
      refreshConversation: 'Refresh current conversation',
      noMessages: 'No messages',
      loadingImage: 'Loading image...',
      read: 'Read',
      selectUser: 'Select a user to start a conversation',
      telegramTitle: 'Telegram support notifications',
      notificationBot: 'Notification bot',
      notificationBotDescription: 'Configure the global bot and receive administrator bindings through the webhook.',
      enabled: 'Enabled',
      tokenConfigured: 'Configured; leave blank to keep it unchanged',
      webhookPublicUrl: 'Public webhook URL',
      webhookDescription: 'Must be an HTTPS URL that can reach this Sub2API instance; the system will register the webhook automatically.',
      saveConfig: 'Save configuration',
      webhookRegistered: 'Webhook registered',
      webhookNotRegistered: 'Webhook not registered',
      myNotificationBinding: 'My notification binding',
      myNotificationBindingDescription: 'Each administrator can bind their own Telegram private chat.',
      testSend: 'Send test',
      generateBindLink: 'Generate binding link',
      ...
      notBound: 'Not bound yet. Save and enable the bot, then generate a link and click Start in Telegram.',
      loadConversationFailed: 'Failed to load conversation',
      loadMessagesFailed: 'Failed to load support messages',
      searchUsersFailed: 'Failed to search users',
      tooManyImages: 'Select up to 2 images, with a maximum of 3 MB per image',
      sendFailed: 'Failed to send message',
      loadTelegramFailed: 'Failed to load Telegram configuration',
      telegramSaved: 'Telegram configuration saved',
      saveFailed: 'Failed to save',
      bindLinkInfo: 'The binding link is valid for 10 minutes. Reopen this panel after completing the binding to check the status.',
      bindLinkFailed: 'Failed to generate binding link',
      bindingUpdateFailed: 'Failed to update binding',
