export default {
    settings: {
      ...
      telegram: {
        title: 'Telegram 机器人',
        description: '配置客服通知与 /stats 查询共用的 Telegram Bot。绑定后可在私聊发送 /stats 查看中转站并发、监控与今日用量。',
        enabled: '启用机器人',
        enabledHint: '关闭后停止 webhook、客服通知与 /stats 查询。',
        botToken: 'Bot Token',
        botTokenPlaceholder: '123456:ABC...',
        botTokenConfiguredPlaceholder: '已配置，留空保持不变',
        webhookBaseURL: 'Webhook 公网地址',
        webhookBaseURLPlaceholder: 'https://api.example.com',
        webhookHint: '必须是能访问当前 Sub2API 的 HTTPS 地址，系统会自动注册 webhook。',
        statsCronEnabled: '定时发送 /stats',
        statsCronEnabledHint: '按 cron 向所有已绑定管理员私聊推送与 /stats 相同的中转站状态。机器人启用后才会实际发送。',
        statsCron: '发送周期 Cron',
        statsCronHint: '标准 5 段 cron（分 时 日 月 周），按服务器应用时区解释。示例：0 * * * * 每小时；0 9 * * * 每天 09:00；*/30 * * * * 每 30 分钟。',
        save: '保存配置',
        saveSuccess: 'Telegram 配置已保存',
        saveFailed: '保存失败',
        loadFailed: '加载 Telegram 配置失败',
        webhookRegistered: 'Webhook 已注册',
        webhookUnregistered: 'Webhook 未注册',
        bindingTitle: '我的通知绑定',
        bindingDescription: '每个管理员绑定自己的 Telegram 私聊。绑定后可发送 /stats 查询中转站状态。',
        generateLink: '生成绑定链接',
        generateLinkFailed: '生成绑定链接失败',
        generateLinkHint: '绑定链接 10 分钟内有效，完成后重新打开此页查看状态',
        testNotify: '发送测试',
        testSuccess: '测试通知已发送',
        testFailed: '测试发送失败',
        unbind: '解除绑定',
      ...
      payment: {
        ...
        field_currency: '支付币种',
        field_fiat: '法币',
        field_currencies: '允许币种',
        field_timeoutSeconds: '订单超时（秒）',
        ...
        field_bepusdtApiBaseHint: 'BEpusdt 服务地址，例如 https://bepusdt.fastvibe.dev。',
        field_bepusdtCurrenciesHint: '多个币种用英文逗号分隔，例如 USDT；建议先只开放 USDT。',
        field_bepusdtTimeoutHint: 'BEpusdt 要求至少 180 秒，默认 1800 秒。',
