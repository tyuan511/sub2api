export default {
  common: {
    ...
    support: {
      ...
      loading: '正在加载...',
      emptyTitle: '有什么可以帮你？',
      emptyDescription: '发送消息后，管理员会在这里回复。',
      agentAlt: 'FastVibe 客服',
      previewAttachment: '放大预览 {name}',
      attachmentLoading: '加载中...',
      sendImage: '发送图片',
      addImage: '添加图片',
      pendingImages: '{count} 张图片待发送',
      clearImages: '清除图片',
      removeImage: '移除图片',
      ...
      sending: '发送中...',
      loadFailed: '加载客服消息失败',
      tooManyImages: '最多选择 2 张图片，单张不能超过 3 MB',
      sentImage: '发送了图片',
      sendFailed: '发送消息失败',
      imagePreview: '图片预览',
      closePreview: '关闭预览'
    ...
    supportAdmin: {
      openWorkspace: '打开客服工作台',
      closeWorkspace: '关闭客服工作台',
      workspaceTitle: '客服工作台',
      workspaceSubtitle: '用户消息与 Telegram 回复',
      workspaceLabel: '客服工作台',
      telegramNotifications: 'Telegram 通知',
      refreshConversations: '刷新全部对话',
      restoreWindow: '还原客服窗口',
      fullscreenWindow: '全屏显示客服窗口',
      restore: '还原',
      enlarge: '放大',
      ...
      previousPage: '上一页',
      nextPage: '下一页',
      refreshConversation: '刷新当前对话',
      noMessages: '暂无消息',
      loadingImage: '加载图片...',
      read: '已读',
      selectUser: '选择一个用户开始对话',
      telegramTitle: 'Telegram 客服通知',
      notificationBot: '通知机器人',
      notificationBotDescription: '配置全局 Bot，并通过 webhook 接收管理员绑定。',
      enabled: '启用',
      tokenConfigured: '已配置，留空保持不变',
      webhookPublicUrl: 'Webhook 公网地址',
      webhookDescription: '必须是能访问当前 Sub2API 的 HTTPS 地址，系统会自动注册 webhook。',
      saveConfig: '保存配置',
      webhookRegistered: 'Webhook 已注册',
      webhookNotRegistered: 'Webhook 未注册',
      myNotificationBinding: '我的通知绑定',
      myNotificationBindingDescription: '每个管理员绑定自己的 Telegram 私聊。',
      testSend: '发送测试',
      generateBindLink: '生成绑定链接',
      ...
      loadMessagesFailed: '加载客服消息失败',
      searchUsersFailed: '搜索用户失败',
      tooManyImages: '最多选择 2 张图片，单张不能超过 3 MB',
      sendFailed: '发送失败',
      loadTelegramFailed: '加载 Telegram 配置失败',
      telegramSaved: 'Telegram 配置已保存',
      saveFailed: '保存失败',
      bindLinkInfo: '绑定链接 10 分钟内有效，完成后重新打开此面板查看状态',
      bindLinkFailed: '生成绑定链接失败',
      bindingUpdateFailed: '更新绑定失败',
      testSent: '测试通知已发送',
      testFailed: '测试发送失败',
      unbindFailed: '解除绑定失败'
    }
