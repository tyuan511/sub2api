export default {
  ...
  keys: {
    ...
    scheduleSmart: '智能调度',
    scheduleSmartDescription: '在所选分组内根据健康、价格、速度和容量动态排序。',
    smartPreferenceLabel: '智能调度倾向',
    balanceRatio: '价格 {price}% · 速度 {speed}%',
    sliderPrice: '更省成本',
    sliderSpeed: '更快响应',
    resetBalance: '重置为均衡',
    ...
    preferencePriceDescription: '成功率达标后优先降低每次成功的实际成本。',
    preferenceSpeed: '速度优先',
    preferenceSpeedDescription: '成功率达标后优先缩短到最终成功的耗时。',
    preferenceBalanced: '均衡',
    preferenceBalancedDescription: '综合平衡成功、成本、速度、容量和切换稳定性。',
    smartSchedulingDisclosure: '所有倾向都先满足成功率硬门槛。系统只在你选择的候选分组内持续优化；已有健康会话保持当前分组，新会话使用最新排序，最终按实际服务分组展示和计费。',
